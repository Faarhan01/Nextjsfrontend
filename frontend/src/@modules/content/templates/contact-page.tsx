  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen pb-24 space-y-6 sm:space-y-8">
      ...
      <PageBanner
        ...
        description="Have a question about an order, product availability, returns, or store locations? Send us a message or visit one of our flagship boutiques."
        badge="24/7 Dedicated Support Concierge"
