...
export function SellerDashboard() {
  ...
  const { sellerAccounts, products, productSubmissions, categories, brands, handleCreateOrUpdateOffer, handleDeleteOffer, handleSubmitNewProduct, handleDeleteProductSubmission, handleUpdateSellerProfile } = useCatalog();
