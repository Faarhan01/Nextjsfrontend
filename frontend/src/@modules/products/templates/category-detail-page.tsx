...
export default function CategoryDetailPage({
  ...
  const renderFilterSidebar = () => (
    <div className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 rounded-2xl p-5 sm:p-6 shadow-sm space-y-6">
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen pb-16 sm:pb-24 space-y-6 sm:space-y-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 space-y-6 sm:space-y-8">
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              {sortBy === 'random' && (
                ...
                >
                  <Shuffle className="w-3 h-3 text-slate-700 dark:text-slate-300" />
                </button>
              )}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-9 space-y-6">
            ...
            {processedList.length === 0 ? (
              <div className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 rounded-2xl py-20 text-center shadow-xs space-y-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <a 
                        ...
                        className="relative w-full sm:w-44 md:w-52 aspect-square overflow-hidden bg-slate-50 dark:bg-slate-900/60 rounded-xl shrink-0 cursor-pointer block"
                      >
                        <SafeImage 
                          src={prod.imageUrl} 
                      ...
                      <div className="flex-1 min-w-0 space-y-2.5 w-full flex flex-col justify-between">
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            <div className="flex items-center gap-1 bg-amber-50/80 dark:bg-amber-950/50 px-2 py-0.5 rounded-md border border-amber-200/60 dark:border-amber-900/50 text-amber-900 dark:text-amber-300 text-xs font-bold w-max">
                        ...
                        <div className="flex items-center justify-between gap-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex-wrap">
                          <div>
                            ...
                            <div className="flex items-baseline gap-1.5">
                              ...
                              {prod.originalPrice && (
                                <span className="text-xs text-slate-400 line-through font-normal">{formatCurrency(prod.originalPrice)}</span>
                              )}
                            </div>
                          </div>
                          ...
                          {onQuickView && (
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-xl transition cursor-pointer flex items-center gap-1.5"
                              >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-3 sm:gap-4">
                {processedList.map((prod) => {
                  ...
                  return (
                    <div 
                      key={prod.id}
                      className="bg-white dark:bg-slate-800 border border-slate-200/90 dark:border-slate-700 rounded-2xl overflow-hidden hover:border-slate-400 dark:hover:border-slate-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between"
                    >
                      <a 
                        href={getProductUrl(prod.id, prod.name)}
