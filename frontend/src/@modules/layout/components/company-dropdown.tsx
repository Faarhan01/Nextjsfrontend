...
export const CompanyDropdown: React.FC<CompanyDropdownProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Popover Card */}
      <div
        className={`absolute top-[calc(100%+6px)] left-0 w-48 popover-surface rounded-2xl border border-card p-1.5 transition-all duration-150 z-50 transform origin-top-left shadow-xl shadow-slate-900/10 dark:shadow-black/40 before:absolute before:-top-2.5 before:left-0 before:right-0 before:h-3 ${
          isOpen
