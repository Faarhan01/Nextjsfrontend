    ...
    >
      <div className="flex items-center">
        <Link
          ...
          className={clx(
            'pl-2.5 lg:pl-3 pr-1 py-1.5 rounded-l-full transition-all duration-200 cursor-pointer outline-none',
            isCategoriesActive
        ...
        <button
          ...
          className={clx(
            'pr-2 lg:pr-2.5 pl-0.5 py-1.5 rounded-r-full transition-all duration-200 cursor-pointer outline-none flex items-center',
            isCategoriesActive
      ...
      <div
        className={clx(
          'absolute top-[calc(100%+6px)] left-0 w-72 sm:w-80 popover-surface rounded-2xl border border-card p-2 transition-all duration-150 z-50 transform origin-top-left shadow-xl shadow-slate-900/10 dark:shadow-black/40 before:absolute before:-top-2.5 before:left-0 before:right-0 before:h-3',
          isOpen
      ...
      >
          ...
          {previewCategories.map((cat) => {
            ...
            return (
              <Link
                ...
                onClick={() => setIsOpen(false)}
                className={clx(
                  'w-full text-left px-2.5 py-2 rounded-xl text-xs font-semibold flex items-center justify-between gap-2.5 transition',
                  isActiveCat
        ...
        <div className="pt-1.5 mt-1 border-t border-slate-100 dark:border-slate-800/80">
          <Link
            ...
            onClick={() => setIsOpen(false)}
            className={clx(
              'w-full text-center px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 hover:opacity-90',
              currentTheme.lightBg
            )}
          >
