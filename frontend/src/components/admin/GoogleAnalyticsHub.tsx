          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              ...
              <span className={`px-2.5 py-1 rounded-full text-[10px] font-extrabold uppercase flex items-center gap-1.5 ${
                ...
                <span className={`w-1 h-1 rounded-full ${verificationResult.status === 'success' ? 'bg-emerald-600 animate-pulse' : 'bg-amber-600'}`} />
            ...
            {activeDocsTab === 'snippets' ? (
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[11px] font-bold text-slate-700 flex items-center gap-1.5">
                      <Code2 className="w-3 h-3 text-blue-600" /> Header Script (Injected as high as possible in &lt;head&gt;)
                    </span>
                    <button
                      type="button"
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[11px] font-bold text-slate-700 flex items-center gap-1.5">
                      <Layers className="w-3 h-3 text-emerald-600" /> Body Fallback (Injected immediately after opening &lt;body&gt;)
                    </span>
                    <button
                      type="button"
              ...
              <div className="space-y-3 text-xs text-slate-600 leading-relaxed bg-slate-50 p-4 rounded-2xl border border-slate-200">
                ...
                <div className="pt-1">
                  ...
                  >
                    Open Tag Manager Workspace <ExternalLink className="w-3 h-3" />
                  </a>
                </div>
              </div>
            )}
